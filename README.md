...
Vervolgend wordt het commando awk gebruikt die lijn per lijn controleert of er niets dubbels is.
...
en via *plt.show()* toon ik de grafiek.

## pythontoPNG.sh
Het runt gewoon via python3 de python code.
